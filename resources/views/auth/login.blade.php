    ...
    <div class="col-md-5">
        <div class="card card-cinema shadow-lg p-4 rounded-3">
            <div class="text-center mb-4">
                ...
                <p class="text-white-70 small">Ruang Kerja Kolaborasi Komunitas Multimedia</p>
            </div>
            ...
            <form action="{{ url('/login') }}" method="POST">
                ...
                <div class="mb-4">
                    <label class="form-label text-white-70 small fw-bold">Password</label>
                    <input type="password" name="password" class="form-control bg-dark border-secondary text-white" placeholder="••••••" required>
                </div>

                <button type="submit" class="btn btn-gold w-100 py-2 mb-3 shadow">Masuk</button>
            </form>

            <div class="text-center mt-2">
                <p class="small text-white-70 mb-0">Belum punya akun? <a href="{{ url('/register') }}" class="text-gold text-decoration-none fw-bold">Daftar Sineas Baru</a></p>
            </div>
        </div>
    </div>
</div>
