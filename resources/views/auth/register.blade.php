    ...
    <div class="col-md-5">
        <div class="card card-cinema shadow-lg p-4 rounded-3">
            <div class="text-center mb-4">
                <h2 class="fw-bold text-gold m-0">Buat Akun FilmInOne</h2>
                <p class="text-white-60 small">Gabung ke dalam ekosistem proyek film kampus</p>
            </div>
            ...
            <form action="{{ url('/register') }}" method="POST">
                @csrf
                <div class="mb-3">
                    <label class="form-label text-white-60 small fw-bold">Nama</label>
                ...
                <div class="mb-3">
                    <label class="form-label text-white-60 small fw-bold">Email</label>
                ...
                <div class="mb-3">
                    <label class="form-label text-white-60 small fw-bold">Password (Minimal 6 Karakter)</label>
                    <input type="password" name="password" class="form-control bg-dark border-secondary text-white" placeholder="••••••" required>
                </div>

                <div class="mb-4">
                    <label class="form-label text-white-60 white-60 fw-bold">Konfirmasi Password</label>
                ...
                <button type="submit" class="btn btn-gold w-100 py-2 mb-3 shadow">Daftar</button>
            </form>

            <div class="text-center mt-2">
                <p class="small text-white-60 mb-0">Sudah punya akun? <a href="{{ url('/login') }}" class="text-gold text-decoration-none fw-bold">Masuk Lewat Sini</a></p>
            </div>
        </div>
    </div>
</div>
