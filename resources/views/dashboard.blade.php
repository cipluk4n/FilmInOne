        ...
        <div class="col-md-4 mb-4">
            <div class="card card-cinema h-100 shadow-sm rounded-3">
                <div class="card-body d-flex flex-column">
                    ...
                    <h4 class="card-title fw-bold text-white mb-2">{{ $project->title }}</h4>
                    <p class="card-text text-muted small flex-grow-1">
                        {{ Str::limit($project->description, 120, '...') }}
                    </p>
                    <div class="border-top border-secondary pt-2 mt-3 text-muted small">
                        🎬 Produser: <strong class="text-white">{{ $project->creator->name }}</strong>
                    </div>
                </div>
